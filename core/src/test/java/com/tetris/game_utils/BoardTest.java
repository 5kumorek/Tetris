...
public class BoardTest extends GameTestBase{
    ...
    public void handlingKeyPressedCorrectlyWhenOutOfBoard() {
        Gdx.graphics = createNiceMock(Graphics.class);
    ...
    public void drawIsExecutedCorrectly() {
        ...
        Mockito.when(Gdx.graphics.getWidth()).thenReturn(100);
        Mockito.when(Gdx.graphics.getHeight()).thenReturn(100);
    ...
    public void handlingDownKeyPressedCorrectly() {
        ...
        try {
            org.powermock.api.mockito.PowerMockito.when(b, "isMouseInsideBoard").thenReturn(true);
            //org.powermock.api.mockito.PowerMockito.when(d, "isMouseInsideBoard").thenReturn(true);
        }catch (Exception e){
            System.out.println(e.toString());
        }
